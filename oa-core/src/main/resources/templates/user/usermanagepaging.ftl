<div class="bgc-w box box-primary">
    ...
    <div class="box-header">
        <h3 class="box-title">
            ...
            <a href="##" class="label label-success" onclick="queryUser();" style="padding: 5px;margin-left:5px;">
                ...
                <div class="col-lg-3 col-sm-3 col-xs-3 col-xxs-3">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select id="deptId" name="deptId" runat="server" AutoPostBack="True" class="form-control">
                ...
                <div class="col-lg-3 col-sm-3 col-xs-3 col-xxs-3">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select id="roleId" name="roleId" runat="server" AutoPostBack="True" class="form-control">
                                    <option value="">---请选择---</option>
                                    <#list roles as role>
