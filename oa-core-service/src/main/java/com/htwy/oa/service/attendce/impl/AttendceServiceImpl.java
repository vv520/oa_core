package com.htwy.oa.service.attendce.impl;
...
public class AttendceServiceImpl implements AttendceService {
    ...
    //查找在这个时间段的每个用户的考勤
//	public Page<Attends> getOneweekatt(int page, String baseKey, Date start,Date end, List<Long> user) {
//		Pageable pa =PageRequest.of(page, 10);
//		if (!StringUtils.isEmpty(baseKey)) {
//			// 模糊查询
//		}else{
//			return attendceDao.getOneweek(start, end, user, pa);
//		}
//		return null;
//		
//	}
    ...
    public Page<Attends> singlepage(int page, String baseKey, long userid, Object type, Object status, Object time) {
        ...
        if (!StringUtils.isEmpty(baseKey)) {
            ...
            attendceDao.getOnemohu(baseKey, userid, pa);
        }
        if (!StringUtils.isEmpty(type)) {
            if (type.toString().equals("0")) {
                //降序
